/**
 * Square X Twitter icon
 *
 * https://fontawesome.com/icons/square-x-twitter?f=brands&s=solid
 *
 * !Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
 */
export function SquareXTwitterIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
 ...
 * !Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
 */
export function SquareGitHubIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
...
/**
 * Square envelope icon
 *
 * https://fontawesome.com/icons/square-envelope?f=classic&s=solid
 *
 * !Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
 */
export function SquareEnvelopeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
 ...
 * Square phone icon
 *
 * https://fontawesome.com/icons/square-phone?f=classic&s=solid
 *
 * !Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
 */
export function SquarePhoneIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
 ...
 * Bluesky icon
 *
 * https://fontawesome.com/icons/square-bluesky?f=brands&s=solid
 *
 * !Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
 */
export function SquareBlueskyIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
